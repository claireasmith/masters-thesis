...
```{r AMAR model fit }
#model for height
AMARmod <- lmer(Log_flw_pollen ~ Infl_max + Stigma_length + Date + Avg_dist + (1|Plant), data=AMAR)
summary(AMARmod)
anova(AMARmod)
...
CACOmod <- lmer(Log_flw_pollen ~ Infl_max + Stigma_length + Date + Avg_dist + (1|Plant), data=CACO)
summary(CACOmod)
anova(CACOmod)
...
```{r CACO fitted values plot, dpi=200}
# emmip_ggplot(emms) #plots predicted slope
ggplot() + 
...
```{r CAHI covariates and pollen load}
...
```{r CAHI model fit}
# fit full model with all terms
CAHImod <- lmer(Log_flw_pollen ~ Infl_max + Stigma_length + Date + Avg_dist + (1|Plant), data=CAHI)
summary(CAHImod)
anova(CAHImod)
# Check for collinearity between predictors
...
```{r CAHI fitted values plot, dpi=200}
# emmip_ggplot(emms) #plots predicted slope
ggplot() + 
...
```{r CAPE covariates and pollen load}
...
ggplot(data=CAPE, aes(x=Stigma_length, y=Log_flw_pollen)) + 
  ...
  geom_smooth(method="lm", se=F) + 
  theme_cs()
ggplot(data=CAPE, aes(x=Avg_dist, y=Log_flw_pollen)) + 
  geom_point(size=3) + 
  scale_x_continuous(name="Average distance to 5 nearest neighbours") + 
  scale_y_continuous(name="Log stigmatic pollen load") + 
  geom_smooth(method="lm", se=F) + 
...
```{r CAPE model fit}
# fit full model with all terms
CAPEmod <- lmer(Log_flw_pollen ~ Infl_max + Stigma_length + Date + Avg_dist + (1|Plant), data=CAPE)
summary(CAPEmod)
anova(CAPEmod)
# Check for collinearity between predictors
...
```{r CAPE fitted values plot, dpi=200}
# emmip_ggplot(emms) #plots predicted slope
ggplot() + 
...
```{r CAPL covariates and pollen load}
...
ggplot(data=CAPL, aes(x=Stigma_length, y=Log_flw_pollen)) + 
  ...
  geom_smooth(method="lm", se=F) + 
  theme_cs()
ggplot(data=CAPL, aes(x=Avg_dist, y=Log_flw_pollen)) + 
  geom_point(size=3) + 
  scale_x_continuous(name="Average distance to 5 nearest neighbours") + 
  scale_y_continuous(name="Log stigmatic pollen load") + 
  geom_smooth(method="lm", se=F) + 
...
```{r CAPL model fit}
# fit full model with all terms
CAPLmod <- lmer(Log_flw_pollen ~ Infl_max + Stigma_length + Date + Avg_dist + (1|Plant), data=CAPL)
summary(CAPLmod)
anova(CAPLmod)
```
...
```{r CAPL fitted values plot, dpi=200}
# emmip_ggplot(emms) #plots predicted slope
ggplot() + 
...
```{r CAPL fitted slope raw values plot, dpi=200}
ggplot() + 
  geom_point(data = CAPL, aes(x=Stigma_length, y=Log_flw_pollen)) + 
  geom_line(data= emmsCAPL, aes(xvar, yvar), linewidth=0.7) +
  # geom_smooth(method="lm", colour="blue", data = CAPL, aes(x=Stigma_length, y=Log_flw_pollen)) + 
  scale_y_continuous(name="Stigmatic pollen load",
                     breaks = log(c(0,1,2,5,10,25,50,100,200,500,1000, 2500)+1),
                     labels = c(0,1,2,5,10,25,50,100,200,500,1000, 2500),
                     limits=c(0,NA)) +
...
```{r CAST covariates and pollen load}
...
emmsCAST <- emmip(CASTmod, ~ Stigma_length, cov.reduce=range,
              type="response", plotit=F)
```

```{r CAST fitted values plot, dpi=200}
# emmip_ggplot(emms) #plots predicted slope
ggplot() + 
  ...
  #             method="lm",
  #             formula = y ~ x, linetype=1, colour="black", se=F, linewidth=0.7) + 
  geom_line(data= emmsCAST, aes(xvar, yvar), linewidth=0.7, colour="blue") +
  scale_y_continuous(name="Stigmatic pollen load",
                     breaks = log(c(0,1,2,5,10,25,50,100,200,500,1000, 2500)+1),
                     labels = c(0,1,2,5,10,25,50,100,200,500,1000, 2500)) +
  scale_x_continuous(name = "Stigma length (cm)") +
...
```{r CAST fitted slope raw values plot, dpi=200}
ggplot() + 
  geom_point(data = CAST, aes(x=Stigma_length, y=Log_flw_pollen)) + 
  geom_line(data= emmsCAST, aes(xvar, yvar), linewidth=0.7) +
...
```{r CHAL covariates and pollen load}
...
```{r PLLA covariates and pollen load}
...
emmsPLLA <- emmip(PLLAmod, ~ Stigma_length, cov.reduce=range,
              type="response", plotit=F)
```

```{r PLLA fitted values plot, dpi=200}
# emmip_ggplot(emms) #plots predicted slope
ggplot() + 
  ...
  #             method="lm",
  #             formula = y ~ x, linetype=1, colour="black", se=F, linewidth=0.7) + 
  geom_line(data= emmsPLLA, aes(xvar, yvar), linewidth=0.7, colour="blue") +
  scale_y_continuous(name="Stigmatic pollen load",
                     breaks = log(c(0,1,2,5,10,25,50,100,200,500,1000, 2500)+1),
                     labels = c(0,1,2,5,10,25,50,100,200,500,1000, 2500)) +
  scale_x_continuous(name = "Stigma length (cm)") +
...
```{r RUAC covariates and pollen load}
...
ggplot(data=RUAC, aes(x=Stigma_length, y=Log_flw_pollen)) + 
  ...
  geom_smooth(method="lm", se=F) + 
  theme_cs()
ggplot(data=RUAC, aes(x=Avg_dist, y=Log_flw_pollen)) + 
  geom_point(size=3) + 
  scale_x_continuous(name="Average distance to 5 nearest neighbours") + 
  scale_y_continuous(name="Log stigmatic pollen load") + 
  geom_smooth(method="lm", se=F) + 
...
```{r RUAC model fit}
# fit full model with all terms
RUACmod <- lmer(Log_flw_pollen ~ Infl_max + Stigma_length + Date + Avg_dist + (1|Plant), data=RUAC)
summary(RUACmod)
anova(RUACmod)
```
...
emmsRUAC <- emmip(RUACmod, ~ Stigma_length, cov.reduce=range,
              type="response", plotit=F)
```

```{r RUAC fitted values plot, dpi=200}
# emmip_ggplot(emms) #plots predicted slope
ggplot() + 
  ...
  #             method="lm",
  #             formula = y ~ x, linetype=1, colour="black", se=F, linewidth=0.7) + 
  geom_line(data= emmsRUAC, aes(xvar, yvar), linewidth=0.7, colour="blue") +
  scale_y_continuous(name="Stigmatic pollen load",
                     breaks = log(c(0,1,2,5,10,25,50,100,200,500,1000, 2500)+1),
                     labels = c(0,1,2,5,10,25,50,100,200,500,1000, 2500)) +
  scale_x_continuous(name = "Stigma length (cm)") +
...
```{r RUCR covariates and pollen load}
...
ggplot(data=RUCR, aes(x=Stigma_length, y=Log_flw_pollen)) + 
  ...
  geom_smooth(method="lm", se=F) + 
  theme_cs()
ggplot(data=RUCR, aes(x=Avg_dist, y=Log_flw_pollen)) + 
  geom_point(size=3) + 
  scale_x_continuous(name="Average distance to 5 nearest neighbours") + 
  scale_y_continuous(name="Log stigmatic pollen load") + 
  geom_smooth(method="lm", se=F) + 
...
```{r RUCR model fit}
# fit full model with all terms
RUCRmod <- lmer(Log_flw_pollen ~ Infl_max + Stigma_length + Date + Avg_dist + (1|Plant), data=RUCR)
summary(RUCRmod)
anova(RUCRmod)
```
...
```{r RUCR fitted values plot, dpi=200}
# emmip_ggplot(emms) #plots predicted slope
ggplot() + 
...
```{r SCPU covariates and pollen load}
...
ggplot(data=SCPU, aes(x=Stigma_length, y=Log_flw_pollen)) + 
  ...
  geom_smooth(method="lm", se=F) + 
  theme_cs()
ggplot(data=SCPU, aes(x=Avg_dist, y=Log_flw_pollen)) + 
  geom_point(size=3) + 
  scale_x_continuous(name="Average distance to 5 nearest neighbours") + 
  scale_y_continuous(name="Log stigmatic pollen load") + 
  geom_smooth(method="lm", se=F) + 
...
```{r SCPU model fit}
# fit full model with all terms
SCPUmod <- lmer(Log_flw_pollen ~ Infl_max + Stigma_length + Date + Avg_dist + (1|Plant), data=SCPU)
summary(SCPUmod)
anova(SCPUmod)
```

No significant effect of anything 

```{r test SCPU model assumptions}
# Check for collinearity between predictors
...
```{r SCMI covariates and pollen load}
...
emmsSCMI <- emmip(SCMImod, ~ Stigma_length, cov.reduce=range,
              type="response", plotit=F)
```

```{r SCMI fitted values plot, dpi=200}
# emmip_ggplot(emms) #plots predicted slope
ggplot() + 
  geom_point(data = SCMImod.fit, aes(x=Stigma_length, y=fit.SCMImod)) + 
  # geom_smooth(data=SCMImod.fit, aes(x=Stigma_length, y=fit.SCMImod),
  #             method="lm",
  #             formula = y ~ x, linetype=1, colour="black", se=F, linewidth=0.7) + 
  geom_line(data= emmsSCMI, aes(xvar, yvar), linewidth=0.7, colour="blue") +
  scale_y_continuous(name="Stigmatic pollen load",
                     breaks = log(c(0,1,2,5,10,25,50,100,200,500,1000, 2500)+1),
                     labels = c(0,1,2,5,10,25,50,100,200,500,1000, 2500)) +
  scale_x_continuous(name = "Stigma length (cm)") +
...
```{r THDI covariates and pollen load}
...
ggplot(data=THDI, aes(x=Stigma_length, y=Log_flw_pollen)) + 
  ...
  geom_smooth(method="lm", se=F) + 
  theme_cs()
ggplot(data=THDI, aes(x=Avg_dist, y=Log_flw_pollen)) + 
  geom_point(size=3) + 
  scale_x_continuous(name="Average distance to 5 nearest neighbours") + 
  scale_y_continuous(name="Log stigmatic pollen load") + 
  geom_smooth(method="lm", se=F) + 
...
```{r THDI model fit}
# fit full model with all terms
THDImod <- lmer(Log_flw_pollen ~ Infl_max + Stigma_length + Date + Avg_dist + (1|Plant), data=THDI)
summary(THDImod)
anova(THDImod)
```

Significant effect of stigma length and average distance

```{r test THDI model assumptions}
# Check for collinearity between predictors
