...
```{r all stig length plots, fig.dim=c(12,14), dpi=200}
stigl %>% 
...
```{r all date plots, fig.dim=c(14,16), dpi=200}
stigl %>% 
...
```{r all infl max plots, fig.dim=c(14,18), dpi=200}
stigl %>% 
...
```{r all inv avg dist plots, fig.dim=c(14,18), dpi=200}
stigl %>% 
